...
NOTE: If your IDE has the Spring Initializer integration, you can complete this process from your IDE.
...
(from `src/main/java/dev/sharanggupta/gs_authenticating_ldap/HomeController.java`) handles a
`GET /` request by returning a simple message:

====
[source,java,tabsize=2]
----
include::src/main/java/dev/sharanggupta/gs_authenticating_ldap/HomeController.java[]
----
====
...
[source,java,tabsize=2]
----
include::src/main/java/dev/sharanggupta/gs_authenticating_ldap/GsAuthenticatingLdapApplication.java[]
----
====
...
[source,xml]
----
include::pom.xml[tag=security,indent=0]
----
====
...
`src/main/java/dev/sharanggupta/gs_authenticating_ldap/WebSecurityConfig.java`) shows:

====
[source,java,tabsize=2]
----
include::src/main/java/dev/sharanggupta/gs_authenticating_ldap/WebSecurityConfig.java[]
----
====
...
plugged into `{0}` such that it searches `uid={0},ou=people,dc=sharanggupta,dc=dev` in
...
spring.ldap.embedded.base-dn=dc=sharanggupta,dc=dev
...
[source,ldif]
----
include::src/main/resources/test-server.ldif[]
----
====
